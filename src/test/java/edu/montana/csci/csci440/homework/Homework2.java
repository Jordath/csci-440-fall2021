...
public class Homework2 extends DBTest {
    ...
    public void createTracksPlusView(){
        //TODO fill this in
        executeDDL("CREATE VIEW tracksPlus AS SELECT TrackId, artists.Name as ArtistName, tracks.name as SongTitle,\n" +
    ...
    public void bulkInsertGenres(){
        ...
        executeUpdate("INSERT INTO genres (Name) VALUES" +
                "               (\"Black Metal\"), (\"Plainsong\"), (\"Tuvan Throat Singing\"), " +
                "               (\"Cottagecore\"), (\"Yodeling Catcore\")");
